   ...
   <View style={styles.userdetail}>
    ...
    borderWidth:2,borderRadius:40  }}
     />
       ...
       <TouchableOpacity style={[styles.status,{backgroundColor:Colors.Appthemecolor}]}>
...
<View style={{height:hp(20),flexDirection:'row',justifyContent:'space-between',marginHorizontal:wp(7)}}>
    
                
<TouchableOpacity onPress={()=>{setModalVisible1(true)}}
                    style={{height:hp(7),width:wp(40),backgroundColor:Colors.Appthemecolor,
                    borderRadius:wp(4),alignItems:'center',justifyContent:'center'
                    }}
                    >
                    <Text style={styles.btntext}>CANCEL ORDER
                        </Text>
                    </TouchableOpacity>
                    ...
                    >
                    <Text style={styles.btntext}>REJECT ORDER
                        </Text>
                    </TouchableOpacity>
